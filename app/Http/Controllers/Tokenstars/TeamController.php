...
class TeamController extends Controller
{
    ...
    public function show(Request $request, $locale = 'en') {
        ...
        $view = view('tokenstars.team', ['contribute_url' => $contribute_url, 'stats_data' => $stats_data]);
    ...
    public function subscribe(Request $request)
    {
        ...
        if (!$email) {
            ...
            /** @var SendGridEmailService $emailService */
            $emailService = app(SendgridEmailService::class);
